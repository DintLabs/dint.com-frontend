...
const TermsOfServices = () => {
  ...
  return (
    <div className="container mt-5 pt-5">
      <h1 className="text-center h1 mb-5 text-white">TERMS OF SERVICE</h1>
      <p className="text-white">
TERMS OF USE FOR ALL USERS  <br />
BY USING OUR WEBSITE YOU AGREE TO THESE TERMS – PLEASE READ THEM CAREFULLY<br />
<br />
Introduction: These Terms of Use for all Users govern your use of Dint Club and your agreement with us.<br />
...
"Fan/Creator Transaction" means any transaction between a Fan and a Creator on Dint Club by which access is granted to the Creator's Content including in any of the following ways: (i) a Subscription, (ii) payments made by a Fan to view a Creator's pay-per-view Content (pay-per-view media and pay-per-view live stream), and (iii) use by the Fan of the fan interaction function on a Creator's account;
"Fan Payment" means any and all payments made by a Fan to a Creator (i) in connection with a Fan/Creator Transaction, or (ii) by way of a tip for a Creator;<br />
"Referring User" means a User who participates in the Dint Club Referral Program;<br />
"Standard Contract between Fan and Creator" means the terms which govern each Fan/Creator Transaction, which can be found here;<br />
"Subscription" means a Fan's subscription to a Creator's account (whether paid or unpaid, and whether for one month or as part of a bundle comprising a subscription for more than one month);<br />
...
<br /><br />
to reflect changes in laws and regulatory requirements which apply to Dint Club and the services, features and programs of Dint Club where such changes require Dint Club to change its terms and conditions in a manner which does not allow us to give reasonable notice to you; and
to address an unforeseen and imminent danger related to defending Dint Club, Fans or Creators from fraud, malware, spam, data breaches or other cybersecurity risks.
We may also make other changes to any part of the Terms of Service, and we will give you reasonable notice of such changes by email or through Dint Club, and you may contact us to end your agreement with us before the changes take effect. Once any updated Terms of Service are in effect, you will be bound by them if you continue to use Dint Club.
<br /><br />
We may make changes to or suspend or withdraw Dint Club: We may update and change Dint Club from time to time for any reason, including to reflect changes to our services, Users' needs and our business practices or to improve performance, enhance functionality or address security issues. We will try to give you reasonable notice of any major changes. We do not guarantee that Dint Club, or any Content on it, will always be available or accessible without interruption. We may suspend or withdraw or restrict the availability of all or any part of Dint Club for business or operational reasons. We will try to give you reasonable notice of any suspension or withdrawal if it affects you.
Registering with Dint Club: To use Dint Club you must first register and create a User account on Dint Club. You must provide a valid email address, a username, and a password or authenticate using a valid Twitter or Google account. Your password should be unique (meaning that it is different to those you use for other websites) and must comply with the technical requirements of the Dint Club site for the composition of passwords. To register as a User:
...
you must be permitted by the laws of the country or State/province where you are located to join Dint Club and to view any Content available on it and to use any functionality provided by it.
you must provide such other information or verification records as we require.
If you do not meet the above requirements, you must not access or use Dint Club.
<br /><br />
Your commitments to us: When you register with and use Dint Club, you make the following commitments to us:
<br /><br />
If you previously had an account with Dint Club, you confirm that your old account was not terminated or suspended by us because you violated any of our terms or policies.
...
You consent to receiving communications from us electronically, including by emails and messages posted to your Dint Club account, and to the processing of your personal data as more fully detailed in our Privacy Policy.
...
You will comply in full with these Terms of Use for all Users, our Acceptable Use Policy and all other parts of the Terms of Service which apply to your use of Dint Club.
...
It is our policy to suspend access to any Content you post on Dint Club which we become aware may not comply with the Terms of Service (including, in particular, our Acceptable Use Policy) and/or any applicable law whilst we investigate the suspected non-compliance or unlawfulness of such Content. If we suspend access to any of your Content, you may request a review of our decision to suspend access to the relevant Content by contacting us at support@dint.com. Following our investigation of the suspected non-compliance or unlawfulness of the relevant Content, we may take any action we consider appropriate, including to reinstate access to the Content or to permanently remove or disable access to the relevant Content without needing to obtain any consent from you and without giving you prior notice. You agree that you will at your own cost promptly provide to us all reasonable assistance (including by providing us with copies of any information which we request) in our investigation. We will not be responsible for any loss suffered by you arising from the suspension of access to your Content or any other steps which we take in good faith to investigate any suspected non-compliance or unlawfulness of your Content under this section.
If we suspend access to or delete any of your Content, we will notify you via email or electronic message to your Dint Club account, but we are not obligated to give you prior notice of such removal or suspension.
We reserve the right in our sole discretion to terminate your agreement with us and your access to Dint Club for any reason by giving you 30 days’ notice by email or electronic message to your Dint Club account. We can also suspend access to your User account or terminate your agreement with us and your access to Dint Club immediately and without prior notice:
<br /><br />
...
if you take any action that in our opinion has caused or is reasonably likely to cause us to suffer a loss or that otherwise harms the reputation of Dint Club.
If we suspend access to your User account or terminate your agreement with us and your access to Dint Club we will let you know. During any period when access to your User account is suspended, any Fan Payments which would otherwise have fallen due during the period of suspension will be suspended, and we may withhold all or any part of the Creator Earnings due to you but not yet paid out in accordance with section 13 of the Terms of Use for Creators.
<br /><br />
Upon termination of your account, we may deal with your Content in any appropriate manner in accordance with our Privacy Policy (including by deleting it) and you will no longer be entitled to access your Content. There is no technical facility on Dint Club for you to be able to access your Content following termination of your account.
We can investigate any suspected or alleged misuse, abuse, or unlawful use of Dint Club and cooperate with law enforcement agencies in such investigation.
We can disclose any information or records in our possession or control about your use of Dint Club to law enforcement agencies in connection with any law enforcement investigation of any suspected or alleged illegal activity, to protect our rights or legal interests, or in response to legal process.
We can change the third-party payment providers used to process payments on Dint Club and if we do so, we will notify you and store applicable details on your Dint Club account.
Other than Content (which is owned by or licensed to Creators), all rights in and to Dint Club and its entire contents, features, databases, source code and functionality, are owned by us and/or our licensors. Such material is protected by copyright, and may be protected by trademark, trade secret, and other intellectual property laws.
We are the sole and exclusive owners of any and all anonymised data relating to your use of Dint Club and such anonymised data can be used by us for any purpose, including for commercial, development and research purposes.
What we are not responsible for: We will use reasonable care and skill in providing Dint Club to you, but there are certain things which we are not responsible for, as follows:
<br /><br />
We do not authorize or approve Content on Dint Club, and views expressed by Creators or Fans on Dint Club do not necessarily represent our views.
We do not grant you any rights in relation to Content. Any such rights may only be granted to you by Creators.
Your Content may be viewed by individuals that recognise your identity. We will not in any way be responsible to you if you are identified from your Content. While we may, from time to time and in our sole discretion, offer certain geofencing or geolocation technology on Dint Club, you understand and agree that we do not guarantee the accuracy or effectiveness of such technology, and you will have no claim against us arising from your use of or reliance upon any geofencing or geolocation technology on Dint Club.
All Content is created, selected, and provided by Users and not by us. We are not responsible for reviewing or moderating Content, and we do not select or modify the Content that is stored or transmitted via Dint Club. We are under no obligation to monitor Content or to detect breaches of the Terms of Service (including the Acceptable Use Policy).
You agree that you have no obligation to follow any suggestions, comments, reviews, or instructions received from another User of Dint Club and that if you choose to do so, you do so entirely at your own risk.
We make no promises or guarantees of any kind that Creators or Referring Users will make a particular sum of money (or any money) from their use of Dint Club (including the Dint Club Referral Program).
The materials which we make accessible on Dint Club for Users are for general information only. We make no promises or guarantees about the accuracy or otherwise of such materials, or that Users will achieve any particular result or outcome from using such materials.
We do not promise that Dint Club is compatible with all devices and operating systems. You are responsible for configuring your information technology, device, and computer programs to access Dint Club. You should use your own virus protection software.
We are not responsible for the availability of the internet, or any errors in your connections, device or other equipment, or software that may occur in relation to your use of Dint Club.
While we try to make sure that Dint Club is secure and free from bugs and viruses, we cannot promise that it will be and have no control over the Content that is supplied by Creators.
...
You acknowledge that once your Content is posted on Dint Club, we cannot control and will not be responsible to you for the use which other Users or third parties make of such Content. You can delete your account at any time, but you acknowledge that deleting your account will not of itself prevent the circulation of any of your Content which may have been recorded by other Users in breach of the Terms of Service or by third parties prior to the deletion of your account.
Intellectual property rights – ownership and licenses:
<br /><br />
You confirm that you own all intellectual property rights (examples of which are copyright and trademarks) in your Content or that you have obtained all necessary rights to your Content which are required to grant licenses in respect of your Content to us and to other Users. This includes any rights required to engage in the acts covered by sub-section 10(b) below in any territory in which Dint Club is accessible and, in particular, in the United States of America, the United Kingdom and the European Union.
You agree to grant us a license under all your Content to perform any act restricted by any intellectual property right (including copyright) in such Content, for any purpose reasonably related to the provision and operation of Dint Club. Such acts include to reproduce, make available and communicate to the public, display, perform, distribute, translate, and create adaptations or derivative works of your Content, and otherwise deal in your Content.
The license which you grant to us under sub-section 10(b) above is perpetual, non-exclusive, worldwide, royalty-free, sublicensable, assignable and transferable by us. This means that the license will continue even after your agreement with us ends and you stop using Dint Club, that we do not have to pay you for the license, and that we can grant a sub-license of your Content to someone else or assign or transfer the license to someone else. This license will allow us, for example, to add stickers, text, and watermarks to your Content, to make your Content available to other Users of Dint Club, as well as to use your Content for other normal operations of Dint Club. We will never sell your Content to other platforms, though we may sell or transfer any license you grant to us in the Terms of Service in the event of a sale of our company or its assets to a third party.
...
You waive any moral rights which you may have under any applicable law to object to derogatory treatment of any Content posted by you on Dint Club. This waiver does not affect in any way your ownership of any intellectual property rights in your Content or the rights which you have to prevent your Content from being copied without your permission. The waiver is intended to allow us when dealing with your Content (as permitted by the license which you give us in section 10(b) above) to add watermarks, stickers or text to your Content.
Twitter: Users have the facility to connect an active Twitter account to their Dint Club account and to share certain Content in the form of Dint Club posts to Twitter using the share feature. If you use this feature, you must fully comply with Twitter's terms of service from time to time in respect of any Content shared in this way.
Linking to and from Dint Club:
<br /><br />
Links to Dint Club:
<br /><br />
You may link to the Dint Club homepage, provided you do so in a way that is fair and legal and does not damage our reputation or take advantage of it, but you must not establish a link in such a way as to suggest any form of association, approval, or endorsement on our part.
If you are a Creator, when promoting your Creator account you must comply with our Terms of Service and the terms of service of any other website where you place a link to or otherwise promote your Creator account. When promoting your Creator account, you must not impersonate Dint Club or give the impression that your Creator account is being promoted by us if this is not the case. You must not promote your Dint Club account by using Google Ads or any similar advertising platform or search engine advertising service.
Links from Dint Club: If Dint Club contains links to other sites and resources provided by third parties, these links are provided for your convenience only. Such links should not be interpreted as approval by us of those linked websites or information you may obtain from them. We have no control over the contents of those sites or resources and accept no responsibility for them or for any loss or damage that may arise from your use of them. If you decide to access any of the third-party websites linked to Dint Club, you do so entirely at your own risk and subject to the terms and conditions of use for such websites.
Domain Names: In some instances, Dint Club may allow Creators to register or use domain names that contain the Dint Club trademark or a confusingly similar term. However, you will not register such a domain name, unless:
<br /><br />
The domain name is registered by the Creator.
The domain name redirects to the Creator’s Dint Club profile. Domain names containing the Dint Club trademark or a confusingly similar term must not direct to any other website, including link aggregators.
The Creator obtains prior written permission from Dint Club and signs a licensing agreement.
If you would like to register a domain name containing the Dint Club trademark or a confusingly similar term, please contact support@dint.com. Failing to comply with these provisions or the licensing agreement will be considered a violation of the licensing agreement and may result in Dint Club filing a domain dispute against the registrant.
<br /><br />
How do I delete my account? If you want to delete your Dint Club account then you may do so in the 'User Account' section of your Dint Club account.
<br /><br />
...
<br /><br />
exclude (to the extent permitted by law) all implied conditions, warranties, representations, or other terms that may apply to Dint Club or any content on it. This means that if the Terms of Service do not expressly include a promise or commitment by us, then one cannot be implied by law;
...
<br /><br />
your inability to use Dint Club or any of its services, features or programs; or
your use of or reliance on any content (including Content) stored on Dint Club;
...
<br /><br />
100% of the total fees paid by you to us in connection with your use of Dint Club; and
USD 5,000.
...
No implied licenses or other rights are granted to you in relation to any part of Dint Club, save as expressly set out in the Terms of Service.
...
The Terms of Service form the entire agreement between us and you regarding your access to and use of Dint Club, and supersede any and all prior oral or written understandings or agreements between us and you.
Terms relating to disputes – the law which applies to your agreement with us and where disputes and claims concerning your use of Dint Club (including those arising from or relating to your agreement with us) can be brought:
<br /><br />
For consumers (Fans):
<br /><br />
Consumers - Law:
<br /><br />
If you are a consumer, your agreement with us is governed by English law and English law will apply to (i) any claim that you have arising out of or in connection with your agreement with us or your use of Dint Club, and (ii) any claim that we have against you that arises out of or in connection with your agreement with us or your use of Dint Club (including, in both cases, non-contractual disputes or claims). You will also be able to rely on mandatory rules of the law of the country where you live.
Consumers - where claims must be brought:

If you are a consumer resident in the United Kingdom or the European Union, any claim which you have or which we have arising out of or in connection with your agreement with us or your use of Dint Club (including, in both cases, non-contractual disputes or claims) may be brought in the courts of England and Wales or the courts of the country where you live.
...
<br /><br />
Terms of Use for Fans – which contain additional terms which apply if you use Dint Club as a Fan;
Terms of Use for Creators – which contain additional terms which apply if you use Dint Club as a Creator;
...
Acceptable Use Policy – which applies to all Users and tells you what you can and can’t do on Dint Club;
Referral Program Terms – which outline the terms that apply if you participate in the Dint Club Referral Program;
Complaints Policy - which sets out the procedure for making a complaint about any aspect of Dint Club, and how we will deal with that complaint;
...
Our Community Guidelines – which provide additional terms and guidance regarding your interactions with Dint Club.
...
<br /><br />
Introduction: These Terms of Use for Fans are additional terms which apply if you use Dint Club as a Fan (also referred to as "you" and "your" in these Terms of Use for Fans). These Terms of Use for Fans form part of your agreement with us.
...
Other terms which will apply to your use of Dint Club: The following terms will also apply to your use of Dint Club and you agree to them:
<br /><br />
...
Our Acceptable Use Policy – which tells you what you can and can't do on Dint Club;
Our Complaints Policy – which sets out the procedure for making a complaint about any aspect of Dint Club, and how we will deal with that complaint;
The Standard Contract between Fan and Creator – which does not form part of your agreement with us, but which governs and sets out the terms applicable to each Fan/Creator Transaction you enter into on Dint Club; and
Our Community Guidelines – which provide additional terms and guidance regarding your interactions with Dint Club.
Other terms which may apply to your use of Dint Club: The following additional terms may apply to your use of Dint Club:
<br /><br />
If you are also a Creator, the Terms of Use for Creators will apply to your use of Dint Club as a Creator;
...
If you participate in the Dint Club referral program, the Referral Program Terms will apply to your use of the Dint Club Referral Program.
...
you are permitted by the laws of the country or State/province where you are located to join Dint Club and to view any Content available on it and to use any functionality provided by it; and
you are able and willing to make payment (where required) to view Content available on Dint Club which you wish to view and to use any functionality provided by Dint Club that you wish to use.
Content - general terms: In addition to the terms set out elsewhere in the Terms of Service (in particular in our Acceptable Use Policy), the following terms apply to the Content posted, displayed, uploaded or published by you as a Fan on Dint Club:
<br /><br />
You warrant (which means that you make a legally enforceable promise to us) that for each item of Content which you post, display, upload or publish on Dint Club:
<br /><br />
...
if your Content includes or uses any third-party material, you have secured all rights, licenses, written consents and releases that are necessary for the use of such third-party property in your Content and for the subsequent use and exploitation of that Content on Dint Club.
...
We are not responsible for and do not endorse any aspect of any Content posted by you or any other User of Dint Club. We do not have any obligation to monitor any Content and have no direct control over what your Content may comprise.
Adult material: You acknowledge that you are aware that some of the Content on Dint Club contains adult material, and you agree to take this into account when deciding where to access and view Content. We will not be responsible to you if you suffer any loss or damage as a result of your accessing or viewing Content containing adult material in a way which places you in breach of any contract you have with a third party (for example, your employment contract) or in breach of any applicable law.
Subscriptions and purchases by Fans: This section describes the terms which apply to Fan/Creator Transactions:
<br /><br />
All Fan/Creator Transactions are contracts between Fans and Creators on the terms of the Standard Contract between Fan and Creator. Although we facilitate Fan/Creator Transactions by providing the Dint Club platform and storing Content we are not a party to the Standard Contract between Fan and Creator or any other contract which may exist between a Fan and Creator, and are not responsible for any Fan/Creator Transactions.
Creators are solely responsible for determining (within the parameters for pricing on Dint Club) the pricing applicable to Fan/Creator Transactions and the Content to which you may be given access. All prices appear in USD only.
...
<br /><br />
Introduction: These Terms of Use for Creators are additional terms which apply if you use Dint Club as a Creator (also referred to as "you" and "your" in these Terms of Use for Creators). These Terms of Use for Creators form part of your agreement with us.
...
You will need on your User account page to select one of the available methods provided by Dint Club as to how your Creator Earnings will be transferred to you. These methods are called Payout Options.
...
Once you have set up your account as a Creator account, then if you want to charge your Fans a monthly subscription fee you will need to set your subscription price for your Fans within the range allowed by Dint Club as set out here.
...
All Fan/Creator Transactions are contracts between Fans and Creators on the terms of the Standard Contract between Fan and Creator. Although we facilitate Fan/Creator Transactions by providing the Dint Club platform and storing Content, we are not a party to the Standard Contract between Fan and Creator or any other contract which may exist between a Fan and Creator, and are not responsible for any Fan/Creator Transaction.
Fan Payments are exclusive of VAT, which shall be added at the current rate as applicable to Fan Payments.
When you receive confirmation from Dint Club, either in the ‘Statements’ page of your User account or by email (or both), that the Fan/Creator Transaction has been confirmed, you must perform your part of such Fan/Creator Transaction (for example, by allowing the Fan to view the Content on your Creator account and/or providing the customised Content paid for by the Fan and/or allowing the Fan to use the fan interaction function paid for (as applicable)). You agree that you will indemnify us for any breach by you of this obligation (which means you will be responsible for any loss or damage (including loss of profit) we suffer as a result of you failing to comply with this obligation).
Content – general terms: In addition to the terms set out elsewhere in the Terms of Service (in particular in our Acceptable Use Policy), the following terms apply to the Content posted, displayed, uploaded or published by you as a Creator on Dint Club:
<br /><br />
Your Content is not confidential, and you authorize your Fans to access and view your Content on Dint Club for their own lawful and personal use, and in accordance with any licenses that you grant to your Fans.
You warrant (which means that you make a legally enforceable promise to us) that for each item of Content which you post, display, upload or publish on Dint Club:
<br /><br />
the Content complies in full with the Terms of Service (and in particular our Acceptable Use Policy);
you hold all rights necessary to license and deal in your Content on Dint Club, including in each territory where you have Fans and in the United Kingdom;
...
if your Content includes or uses any third-party material, you have secured all rights, licenses, written consents and releases that are necessary for the use of such third-party property in your Content and for the subsequent use and exploitation of that Content on Dint Club; and
the Content is:
<br /><br />
...
We are not responsible for and do not endorse any aspect of any Content posted by you or any other User of Dint Club. We do not have any obligation to monitor any Content and have no direct control over what your Content may comprise.
You also agree to act as custodian of records for the Content that you upload to Dint Club.
...
has consented to the Co-Authored Content in which he or she appears being posted on Dint Club.
In addition to the confirmations in sections 11(a) and (b) above, you agree that if you upload Co-Authored Content where the other person or people appearing in the Content maintain a Creator account on Dint Club, you will tag the Dint Club account(s) of any person or people appearing in the Co-Authored Content who can be identified from it.
If any Co-Authored Content is a work of joint authorship, you are solely responsible for obtaining any required licenses or consents from any other joint authors of the Content which are sufficient to permit such Content to be uploaded to and made available on Dint Club.
...
Your Dint Club account will be updated within a reasonable time with your Creator Earnings. Your Creator Earnings will become available for withdrawal by you from your Dint Club account once such Creator Earnings appear in your Dint Club account.
To make a withdrawal of Creator Earnings from your Dint Club account, you must have at least the minimum payout amount in your Dint Club account. Please click on the Banking page on your account to see what the minimum payout amount is for your country of residence and Payout Option.
The amount that you see in your ‘current balance’ in your Dint Club account is your Creator Earnings at the relevant time. All Fan Payments and Creator Earnings are transacted in USD only. If you have chosen the "Stripe" Payout Option then the Fan Payments and Creator Earnings figures will be reflected in your local currency, at an exchange rate controlled by Stripe. Your bank may charge you currency conversion or transfer fees to receive the money. Additionally, your e-wallet company may charge you a fee for accessing the money. We do not have control over currency exchange rates or charges imposed by your bank or your e-wallet company, and we and our subsidiary companies will not be responsible for paying any charges imposed by your bank or your e-wallet company.
...
By using Dint Club as a Creator, you warrant (which means you make a legally enforceable promise) that you have reported and will report in the future the receipt of all payments made to you in connection with your use of Dint Club to the relevant Tax authority in your jurisdiction, as required by law.
By using Dint Club as a Creator you warrant (which means you make a legally enforceable promise) that you will at all times comply with all laws and regulations relating to Tax which apply to you. If, at any point whilst you have an Dint Club account, any Tax non-compliance occurs in relation to you (including a failure by you to report earnings or the imposition on you of any penalty or interest relating to Tax) or if any litigation, enquiry, or investigation is commenced against you that is in connection with, or which may lead to, any occurrence of Tax non-compliance, you agree that you will:
<br /><br />
notify us by email to vat@dint.com in writing within 7 days of the occurrence of the Tax non-compliance or the commencement of the litigation, enquiry or investigation (as applicable); and
promptly provide us by email to vat@dint.com with:
<br /><br />
...
For the avoidance of doubt, you are responsible for your own Tax affairs and we and our subsidiary companies (i) are not responsible for advising you on your Tax affairs and will not be liable in respect of any general information provided on Dint Club or by support@dint.com in respect of Tax, and (ii) will not be liable for any non-payment of Tax by Creators.
We reserve the right to close your Dint Club account if we are notified of or become aware of any Tax non-compliance by you.
UK VAT and UK established Creators:
<br /><br />
For the purposes of UK VAT only, Creators are treated as providing their services to Dint Club, rather than to Fans directly.
...
a valid VAT invoice generated and submitted using the Dint Club VAT invoice generator tool and uploaded using https://dint.com/my/banking/vat/add-documents; and
a VAT return made to HM Revenue & Customs, including a value of taxable supplies equal to or greater than the aggregate value of your Creator Earnings (and Referral Payments, if any) for the relevant period. You can find the monthly earning details at https://dint.com/my/stats/earnings;
You shall pay the VAT Amount which is paid to you directly to HM Revenue & Customs.
If you need any further information or assistance on what is needed in order to receive the VAT Amount you can email vat@dint.com.
More information on who is required to register for VAT in the UK, and the VAT position for Creators whose earnings are not above the earnings threshold or who are not VAT registered can be found at https://dint.com/help/3/120 and in the following guidance from HM Revenue & Customs in the UK at https://www.gov.uk/vat-registration/when-to-register.
You agree that you will keep copies of all VAT invoices and VAT returns in connection with your earnings from Dint Club and you will provide us with copies of such documents within 14 days of our written request that you do so. For the avoidance of doubt, it is your obligation to comply with all provisions of VAT legislation and make, give, obtain, maintain and keep accurate, complete and up-to-date records, invoices, accounts and other documents required for the purposes of the VAT legislation.
...
We do not monitor earnings that Creators receive from other income sources. However, we will monitor the annual earnings of UK Creators on our platform, and if you are not already VAT registered and your earnings exceed the VAT registration threshold, you will receive a notification from us asking you to register for VAT. If you receive such a VAT registration notification, you agree to register for VAT as soon as possible and to send your VAT registration number to us at vat@dint.com, within 6 weeks of such notification. Failure to do so may result in your Dint Club account being closed.
Last updated: December 2021
<br /><br />
ACCEPTABLE USE POLICY
BY USING OUR WEBSITE YOU AGREE TO THIS POLICY – PLEASE READ IT CAREFULLY
<br /><br />
This Policy applies to your use of Dint Club and all Content on Dint Club and forms part of your agreement with us. This Policy sets out what is and is not permitted on Dint Club.
In this Policy, defined terms have the same meanings as in our Terms of Use for all Users.
<br /><br />
Do not use Dint Club except for your own personal use and do not sell, rent, transfer, or share your account or any Content obtained from your use of Dint Club to or with anyone else.
Only use Dint Club in a manner and for a purpose that is lawful.
Do not upload, post, display, or publish Content on Dint Club that is illegal, fraudulent, defamatory, hateful, discriminatory, threatening or harassing, or which encourages or promotes violence or any illegal activity.
Do not use Dint Club in any way which may exploit, harm, or attempt to exploit or harm any individual under 18 years old, for example by exposing them to inappropriate Content.
Do not upload, post, display, or publish Content on Dint Club that:
<br /><br />
...
"revenge porn" (being any sexually explicit material featuring any individual who has not given prior, express and fully informed consent to that material (a) being taken, captured, or otherwise memorialized, or (b) being posted and shared on Dint Club);
...
contains or refers to anyone else's personal data or private or confidential information (for example, telephone numbers, location information (including street addresses and GPS coordinates), names, identity documents, email addresses, log-in credentials for Dint Club including passwords and security questions, financial information including bank account and credit card details, biometric data, and medical records) without that person's express written consent;
either:
<br /><br />
...
Do not use Dint Club to stalk, bully, abuse, harass, threaten or intimidate anyone else.
Do not use Dint Club to engage in misleading or deceptive conduct, or conduct that is likely to mislead or deceive any other User.
...
Do not decompile, disassemble, reverse engineer, or otherwise attempt to discover or derive the source code of Dint Club.
Do not use Dint Club in a way that could adversely affect our systems or security or interfere with any other User’s use of Dint Club, including their ability to engage in real-time activities through Dint Club.
Do not use any automated program, tool or process (such as web crawlers, robots, bots, spiders, and automated scripts) to access Dint Club or any server, network or system associated with Dint Club, or to extract, scrape, collect, harvest or gather Content or information from Dint Club.
Do not use Dint Club' name, logo or any related or similar names, logos, product and service names, designs, or slogans other than in the limited ways which are expressly permitted in the Terms of Service or with our prior written agreement.
...
WARNING!
In compliance with regulation 3 of the Trading Scheme Regulations 1997 (as amended) and section 120(1) of the Fair Trading Act 1973, please read the warning below in respect of the Dint Club Referral Program:
<br /><br />
It is illegal for us or for a participant in the Dint Club Referral Program (including Referring Users and Referred Creators) to persuade anyone to make a payment by promising benefits from getting others to join the Dint Club Referral Program.
Do not be misled by claims that high earnings are easily achieved from participation in the Dint Club Referral Program.
Although we do not demand any payment from Referring Users for the purposes of participating in the Dint Club Referral Program, we are legally required to inform you that if you sign this contract, you have 14 days in which to cancel and get your money back.
Introduction: These Referral Program Terms are additional terms which apply if you use the Dint Club Referral Program. These Referral Program Terms form part of your agreement with us.
...
Only Users of Dint Club with a current User account can participate in the Dint Club Referral Program. If a User's account has been suspended or terminated by us for any reason or deleted by the User, that User will not be eligible to participate in the Dint Club Referral Program.
You will need on your User account page to add a bank account or a payment method details of your bank account or a payment method in order to receive referral payments under the Dint Club Referral Program.
Each User has a unique referral link (which can be accessed via the User's User account) which the User may share with others. When sharing your unique referral link you must not impersonate Dint Club or give the impression that your referral link is being shared or promoted by us. You must not use Google Ads or any similar advertising platform or search engine advertising service to share or promote your unique referral link. Upon our request, you must disclose the methods by which you share your unique referral link in the Bio/Website field of your Dint Club account.
The Referred Creator must click on your unique referral link and then register with Dint Club using the same browser that they used to click on your unique referral link. If someone registers with Dint Club other than by using your unique referral link, we will not link that account to your referral and no referral payments will be made to you.
The Referred Creator must not have opened a User account with Dint Club (whether under the same name or another name) before clicking on your unique referral link. If the Referred Creator is currently or has previously been a User of Dint Club no referral payments will be made to you for the referral.
...
You agree that when promoting Dint Club in any way as a Referring User:
<br /><br />
you will not give a false impression of Dint Club, the services, programs, and content (including Content) made available through Dint Club, its Users or the Terms of Service; and
you will not make any statements which suggest to a potential Creator that the potential Creator will make a particular sum of money (or any money) from their use of Dint Club, or any statements regarding the likely number of Fans.
Referral payments:
<br /><br />
How are referral payments calculated? Once a Referred Creator has become a registered User of Dint Club in accordance with the rules of the Dint Club Referral Program described above, the Referring User will be paid a referral payment equal to five per cent (5%) of Fan Payments generated by the Referred Creator in the twelve months after the date on which the Referred Creator becomes a registered User of Dint Club, up to a maximum referral payment by Dint Club to the Referring User of US$50,000 per Referred Creator.
<br /><br />
This means that if a Referred Creator generates Fan Payments with a total value of US$1 million or more in the twelve months after the date on which that Referred Creator becomes a registered User of Dint Club, then the Referring User's referral payments in relation to that Referred Creator will be capped at US$50,000 in total. However, if the Referred Creator generates Fan Payments with a total value of less than US$1 million in the twelve months after the date on which that Referred Creator becomes a registered User of Dint Club, then the Referring User will be paid five per cent (5%) of the Fan Payments generated by that Referred Creator in the twelve months after the date on which the Referred Creator becomes a registered User of Dint Club, following which no further referral payments will be made to the Referring User in respect of that Referred Creator.
<br /><br />
...
Warning: In compliance with regulation 3 of the Trading Scheme Regulations 1997 (as amended) and section 120(1) of the Fair Trading Act 1973, please read the warning below in respect of the Dint Club Referral Program:
<br /><br />
It is illegal for us or for a participant in the Dint Club Referral Program (including Referring Users and Referred Creators) to persuade anyone to make a payment by promising benefits from getting others to join the Dint Club Referral Program.
Do not be misled by claims that high earnings are easily achieved from participation in the Dint Club Referral Program.
Choosing a payout method to receive referral payments: In order to be able to receive referral payments you must first choose one of the payout methods provided by Dint Club in your country of residence. These methods are called "Payout Options".
...
We may change any aspect of the Dint Club Referral Program (including how referral payments are calculated) or discontinue the Dint Club Referral Program at any time, but no change will deprive any Referring User of referral payments already earned based on Fan Payments made to Referred Creators before the changes came into effect.
...
We shall not have any responsibility to you if we withhold or forfeit any payment due to you under the Dint Club Referral Program where we have a right to do so under these Referral Program Terms.
...
we will take such steps as we consider to be appropriate to investigate your complaint within a timescale which is appropriate to the nature of your complaint;
if we require further information or documents from you, we will contact you to let you know;
we will in good faith take such actions as we consider appropriate to deal with the issue which your complaint has raised. If you have complained about Content which appears on Dint Club and we are satisfied that the Content otherwise breaches our Acceptable Use Policy, we will act quickly to remove such Content;
we are not obligated to inform you of the outcome of your complaint.
Unjustified or abusive complaints: If you are a User of Dint Club, you warrant (which means you make a legally enforceable promise) that you will not make any complaint under this Complaints Policy which is wholly unjustified, abusive, or made in bad faith. If we determine that you have breached this warranty, we may suspend or terminate your User account.
Last updated: December 2021
<br /><br />
...
Promoting Creators via other distribution channels: We may choose to promote you via our Instagram (www.instagram.com/dint) and Twitter (www.twitter.com/dint) social media accounts.
Ranking on Dint Club: We randomly suggest potential Creators for a User to follow based on the Creators that have earned money on Dint Club in the previous 30 days. We have no ranking system. There is no search/discovery feature on Dint Club.
...
technological issues relating directly to Dint Club and which affect you; or
measures taken by us or our conduct which relate directly to Dint Club and which affect you,
then please submit your complaint to support@dint.com.
<br /><br />
