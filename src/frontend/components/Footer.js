            ...
            <footer style={{marginTop:"200px"}}>
                ...
                <div className="footer">
                    ...
                    <section className="middle_on_mobile hide_on_leptop">
                        ...
                        <a href="https://twitter.com/dint">  <div className="social_box" style={{ "margin": 0 }}><FaTwitter size={20} /></div></a>
                        <a href="https://www.instagram.com/dint">   <div className="social_box"><FaInstagram size={20} /></div></a>
                        <a href="https://discord.gg/zk97Vf4YyX">   <div className="social_box"><FaDiscord size={20} /></div></a>
                        <a href="https://www.facebook.com/dintclub">  <div className="social_box"><FaFacebookF size={20} /></div></a>
                        <a href="https://www.youtube.com/channel/UCGXYFkXyYYIZIjOyjDQ6S7w">  <div className="social_box"><FaYoutube size={20} /></div></a>
                        </div>
                    </section>
                </div>
            </footer>
