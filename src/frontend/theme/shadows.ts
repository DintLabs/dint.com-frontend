...
export const searchBarShadows = {
  variantInset:
    'rgba(204, 219, 232, 0.75) 3px 3px 6px 0px inset, rgba(204, 219, 232, 0.25) -3px -3px 6px 0px inset',
  variantOffset: 'rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px',
  variantHome1: 'rgba(0, 0, 0, 0.24) 0px 3px 8px'
};
