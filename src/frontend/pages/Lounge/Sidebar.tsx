    ...
    <>
      <List>
        <ListItem
          sx={{
            color:
              HOME_SIDE_MENU.HOME === selectedMenu || HOME_SIDE_MENU.LOUNGE === selectedMenu
                ? 'text.primary'
                : 'text.secondary',
            cursor: 'pointer'
          }}
        ...
        <ListItem
          sx={{
            cursor: 'pointer',
            color: HOME_SIDE_MENU.SUBSCRIPTIONS === selectedMenu ? 'text.primary' : 'text.secondary'
          }}
          onClick={() => {
        ...
        >
          ...
          <ListItemText primary={<Typography variant="subtitle1">Subscriptions</Typography>} />
        </ListItem>
        <ListItem
          sx={{
            cursor: 'pointer',
            color: HOME_SIDE_MENU.MY_EVENT === selectedMenu ? 'text.primary' : 'text.secondary'
          }}
          onClick={() => {
        ...
        >
          ...
          <ListItemText primary={<Typography variant="subtitle1">My Events</Typography>} />
        </ListItem>
